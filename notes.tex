...
\tb{ Sample complexity question.}  Suppose $K$ can be invalidated for the true plant $P$. Assume
...
\tb{Remark} Why not `invalidate' $K$ just by analyze the robust performance given the plant $P$ with
